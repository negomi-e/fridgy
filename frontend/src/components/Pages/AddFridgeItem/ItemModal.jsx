    ...
    render() {
        ...
        return (
            ...
            <InputGroup size="lg">
                    ...
                    <Modal.Footer>
                        <Button className={styles.expiryButton} variant='outline-primary' onClick={this.setOpenCalendar} aria-controls="example-collapse-text" aria-expanded={this.state.isSelectDateOpen} type='submit' value='expireDate'>Expiry Date: {this.state.day}.{this.state.month}.{this.state.year}</Button>
                        {this.state.update ?
